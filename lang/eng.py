...
SETTINGS = {
    ...
    "thumb" : [
        {"SETTING ⚙️» THUMBNAIL 📷 ":"nabilanavab"," ♻ يضيف ♻ ":"set|thumb+"," «الرئيسية« ":"Home|B"},
        {"SETTING ⚙️» THUMBNAIL 📷 ":"nabilanavab"," ♻ يتغيرون ♻ ":"set|thumb+"," حذف 🗑 ":"set|thumb-"," ««العودة إلى الصفحة الرئيسية« ":"Home|B2S"}
    ],
    "fname": [
        {"SETTING ⚙️» FNAME 📷 ":"nabilanavab"," ♻ يضيف ♻ ":"set|fname+"," «الرئيسية« ":"Home|B2S"},
        {"SETTING ⚙️» FNAME 📷 ":"nabilanavab"," ♻ يتغيرون ♻ ":"set|fname+"," حذف 🗑 ":"set|fname-"," «العودة إلى الصفحة الرئيسية« ":"Home|B2S"}
    ] ,
    "api": [
        {"SETTING ⚙️» API 📷 ​​":"nabilanavab"," ♻ يضيف ♻ ":"set|api+"," «الرئيسية« ":"Home|B2S"},
        {"SETTING ⚙️» API 📷 ​​":"nabilanavab"," ♻ يتغيرون ♻ ":"set|api+"," 🗑 حذف 🗑 ":"set|api-"," «العودة إلى الصفحة الرئيسية« ":"Home|B2S"}
    ] ,
    "capt": [
        {"الإعداد ⚙️» التسمية التوضيحية 📷":"nabilanavab"," ♻ يضيف ♻ ":"set|capt+"," «العودة إلى الصفحة الرئيسية« ":"Home|B2S"},
        {"الإعداد ⚙️» التسمية التوضيحية 📷":"nabilanavab"," ♻ يتغيرون ♻ ":"set|capt+"," حذف 🗑 ":"set|capt-","«العودة إلى الصفحة الرئيسية« ":"Home|B2S"}
    ]
}
...
URL = {
    ...
    "openCB": {"افتح متصفح": "{}"}, "_error": "` Some Thing Went Wrong = (`\n \n` {}` ",
    "_get": "[فتح الدردشة] ({}) \n \n ** حول الدردشة ↓ ** \n نوع الدردشة: {} \n اسم الدردشة: {} \n الدردشة Usr: @ {} \n"
             "معرف الدردشة: {} \n التاريخ: {} \n \n ** حول الوسائط ↓ ** \n الوسائط: {} \n اسم الملف: {} \n حجم الملف: {} \n \n نوع الملف: {}"
}
