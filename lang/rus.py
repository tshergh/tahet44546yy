...
/send: для трансляции, сообщение в личку """,
    "footerHelp": f"""\n\n\nИсходный код: [file conveter]({str(settings.SOURCE_CODE)})
...
Вещи с PDF-файлами @Telegram\n\nСпасибо @ta_ja199 за этого замечательного бота 😅""",
    "HomeACB": {
...
BAN = {
    ...
    "banCB" : {
        ...
        "« Обновить канал »": "https://t.me/i2pdfbotchannel"
    },
...
\n`Пожалуйста, пришлите мне файл меньше {}mb Size` 🙃""",
    "bigCB" : {"💎 Создать бота поддержки 2Gb 💎" : "https://t.me/i2pdfbotchannel"},
